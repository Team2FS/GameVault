...
public class CustomFavoriteChallengeAdapter extends RecyclerView.Adapter<CustomFavoriteChallengeAdapter.ViewHolder> {
    private List<Article> data;
    public CustomFavoriteChallengeAdapter(List<Article> data){
        this.data = data;
    }

    @Override
    public CustomFavoriteChallengeAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View rowItem = LayoutInflater.from(parent.getContext()).inflate(R.layout.favorite_challenge_layout, parent, false);
        return new ViewHolder(rowItem);
    }

    @Override
    public void onBindViewHolder(CustomFavoriteChallengeAdapter.ViewHolder holder, int position) {
